...
<div class="content mt-3">
    ...
    <?php echo form_open_multipart('admin-news-update-form'); ?>

    <input type="hidden" id="hide" name="newsId" value="<?php echo $newsId; ?>">
                    ...
                    <div class="col-12 col-md-9">
                        <select name="category" id="select" class="form-control">
                            ...
                            <?php foreach ($categories as $item) { ?>
                                <option value="<?php echo $item->id; ?>" <?php if ($catId == $item->id) echo 'selected'; ?>><?php echo $item->name; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
