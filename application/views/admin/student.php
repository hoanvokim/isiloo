                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="<?php echo base_url() . "admin/student/create/" ?>"
                            ...
                            <table id="all-category-data-table" class="table table-striped table-bordered">
                                ...
                                <?php foreach ($students as $item) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url() . "admin/student/update/" . $item->id; ?>"> <?php echo $item->name; ?> </a>
                                        </td>
                                        <td><?php echo $item->status; ?></td>
                                        <td><?php echo $item->created_date; ?></td>
                                        <td><?php echo $item->updated_date; ?></td>
                                        <td>
                                            <a href="<?php echo base_url() . "admin/student/delete/" . $item->id; ?>"
