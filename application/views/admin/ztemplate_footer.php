...
<script src="<?php echo base_url(); ?>webresources_admin/assets/js/lib/chart-js/Chart.bundle.js"></script>
<script src="<?php echo base_url(); ?>webresources_admin/assets/js/dashboard.js"></script>
<script src="<?php echo base_url(); ?>webresources_admin/assets/js/widgets.js"></script>
<script src="<?php echo base_url(); ?>webresources_admin/assets/js/lib/vector-map/jquery.vmap.js"></script>
