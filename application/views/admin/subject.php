        ...
        <div class="col-12">
            <div class="page-header float-left">
                <div class="page-title">
                    <h1>Quản lý: Chủ đề trong câu hỏi</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php echo form_open_multipart('admin-subject-create-form'); ?>
                            ...
                            <table id="all-album-data-table" class="table table-striped table-bordered">
                                ...
                                <?php foreach ($items as $item) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url() . "admin/central/subject_delete/" . $item->id; ?>"
                            ...
                            <small class="form-text text-muted">Được sử dụng tại: </small><a href="<?php echo base_url() . 'center/lien-he'; ?>">Liên hệ</a>
                        </div>
                    </div>
                </div>
